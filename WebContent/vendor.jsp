    ...
    <header>
        ...
        <div class="hd-gf hd-gf-burg">
            ...
            <div class="burguer-sidebar" id="burg-on">
                ...
                <!--<h5><a href="#">Fale conosco <i class="fab fa-facebook"></i> <i class="fab fa-twitter"></i> <i class="fab fa-google-plus"></i></a></h5>-->
    ...
    <section>
        ...
        <div class="content-vendor">
            ...
            <div class="cv-img-top">
                <img src="img/vendor.jpg" alt="#">
            </div>

            <div class="content-vendor-bottom">
                ...
                <div class="cv-info">
                    <h2><%= session.getAttribute("vendor-name")%></h2>
                    <p><%= session.getAttribute("vendor-address")%></p>
                    <p>4.37 avaliacoes de 27 reviews</p>
                </div>
        ...
        <div class="prod">
            ...
            <!--LISTA ELETRONICOS-->
            <% List<Produto>list = new Produto().vendor(Long.parseLong(session.getAttribute("id-vendor").toString()));%>
            <!--LISTA ELETRONICOS-->
